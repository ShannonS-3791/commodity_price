...
download.file("https://thedocs.worldbank.org/en/doc/5d903e848db1d1b83e0ec8f744e55570-0350012021/related/CMO-Historical-Data-Monthly.xlsx",sprintf("%sCMO-Historical-Data-Monthly.xlsx",folder_Raw))
#may need to add option `mode = "wb"` in the download file command, if the file gets corrupted during download. Might happen on windows?
...
#Create Table that just has PCPS as the Dataset ID
imf_ds_list <- "PCPS"
...
# Loop through each row of the indicators
  ...
  for (i in rownames(imf_comm_indicators)) {
    ...
    ds_code <- as.character(imf_comm_indicators[i,"dataset_id"])
...
rm(wb_I01,wb_I02,wb_I03,wb_P01,wb_P02,wb_P03,wb01,wb03a,wb03b,wb03c)
...
## Combine World Bank and IMF Data
